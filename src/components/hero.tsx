...
const Hero: React.FC = () => {
  const { t } = useTranslation();
    ...
    return (
    <section className="flex-col md:flex-row items-center justify-center px-6 md:px-0 py-0 flex bg-white">
    ...
    <div className="md:w-1/2 flex flex-col justify-start items-center text-center md:items-start md:text-left md:pl-10 h-full md:h-[80vh] md:py-10 md:pt-24 space-y-8">
      ...
      <p className="line-clamp-4 max-h overflow-hidden text-lg text-gray-700 mt-4">{t('hero.descr')}</p>
